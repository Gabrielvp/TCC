...
CREATE TABLE IF NOT EXISTS `bd_tcc`.`Fatura` (
  ...
  INDEX `fk_Fatura_Pessoa1_idx` (`idPessoa` ASC),
...
CREATE TABLE IF NOT EXISTS `bd_tcc`.`Produto_Orcamento` (
  ...
  INDEX `fk_Produto_has_Orcamento_Orcamento1_idx` (`idOrcamento` ASC),
  INDEX `fk_Produto_has_Orcamento_Produto1_idx` (`idProduto` ASC),
