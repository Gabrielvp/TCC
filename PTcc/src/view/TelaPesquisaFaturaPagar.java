 ...
 * @author felipe.cunha
 */
public class TelaPesquisaFaturaPagar extends javax.swing.JDialog {

    /**
     * Creates new form TelaPesquisaOrcamento
     */
    public TelaPesquisaFaturaPagar(java.awt.Frame parent, boolean modal, int cd, Pessoa p) {
        super(parent, modal);
        initComponents();
        this.codigo = cd;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaPesquisaFaturaPagar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TelaPesquisaFaturaPagar dialog = new TelaPesquisaFaturaPagar(new javax.swing.JFrame(), true, 0, null);
